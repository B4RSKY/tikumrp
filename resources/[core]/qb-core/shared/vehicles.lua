...
--  { model = 'blista',        name = 'Blista',                 brand = 'Dinka',      price = 13000,    category = 'compacts',     type = 'automobile', shop = 'pdm' },
    { model = 'brioso',        name = 'Brioso R/A',             brand = 'Grotti',     price = 1072500,  category = 'compacts',     type = 'automobile', shop = 'pdm' },
...
--  { model = 'issi6',         name = 'Issi Nightmare',         brand = 'Weeny',      price = 80000,    category = 'compacts',     type = 'automobile', shop = 'pdm' },
    { model = 'panto',         name = 'Panto',                  brand = 'Benefactor', price = 795000,   category = 'compacts',     type = 'automobile', shop = 'pdm' },
...
--  { model = 'buccaneer',     name = 'Buccaneer',              brand = 'Albany',     price = 22500,    category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'buccaneer2',    name = 'Buccaneer Rider',        brand = 'Albany',     price = 530250,   category = 'muscle',       type = 'automobile', shop = 'pdm' },
--  { model = 'chino',         name = 'Chino',                  brand = 'Vapid',      price = 5000,     category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'chino2',        name = 'Chino Luxe',             brand = 'Vapid',      price = 762500,   category = 'muscle',       type = 'automobile', shop = 'pdm' },
...
--  { model = 'dukes3',        name = 'Beater Dukes',           brand = 'Imponte',    price = 45000,    category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'faction',       name = 'Faction',                brand = 'Willard',    price = 630000,   category = 'muscle',       type = 'automobile', shop = 'pdm' },
...
--  { model = 'hotknife',      name = 'Hotknife',               brand = 'Vapid',      price = 90000,    category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'hustler',       name = 'Hustler',                brand = 'Vapid',      price = 3225000,  category = 'muscle',       type = 'automobile', shop = 'pdm' },
...
--  { model = 'buffalo4',      name = 'Buffalo STX',            brand = 'Bravado',    price = 345000,   category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'manana',        name = 'Manana',                 brand = 'Albany',     price = 1104000,  category = 'muscle',       type = 'automobile', shop = 'pdm' },
--  { model = 'manana2',       name = 'Manana Custom',          brand = 'Albany',     price = 24000,    category = 'muscle',       type = 'automobile', shop = 'pdm' },
    { model = 'tampa2',        name = 'Drift Tampa',            brand = 'Declasse',   price = 2012500,  category = 'muscle',       type = 'automobile', shop = 'pdm' },
...
--  { model = 'btype3',        name = 'Roosevelt Valor',        brand = 'Albany',     price = 63000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'casco',         name = 'Casco',                  brand = 'Lampadati',  price = 1720000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
...
--  { model = 'fagaloa',       name = 'Fagaloa',                brand = 'Vulcar',     price = 13000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'feltzer3',      name = 'Stirling GT',            brand = 'Benefactor', price = 1970750,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
...
--  { model = 'jb7002',        name = 'JB 700W',                brand = 'Dewbauchee', price = 40000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'mamba',         name = 'Mamba',                  brand = 'Declasse',   price = 2671000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
...
--  { model = 'driftnebula',   name = 'Nebula Turbo',           brand = 'Vulcar',     price = 100000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    --- Sports (6)
    { model = 'alpha',         name = 'Alpha',                  brand = 'Albany',     price = 1115000,  category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'banshee',       name = 'Banshee',                brand = 'Bravado',    price = 1195000,  category = 'sports',       type = 'automobile', shop = 'luxury' },
--  { model = 'bestiagts',     name = 'Bestia GTS',             brand = 'Grotti',     price = 37000,    category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'buffalo',       name = 'Buffalo',                brand = 'Bravado',    price = 1113750,  category = 'sports',       type = 'automobile', shop = 'luxury' },
...
--  { model = 'comet4',        name = 'Comet Safari',           brand = 'Pfister',    price = 110000,   category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'comet5',        name = 'Comet SR',               brand = 'Pfister',    price = 2050000,  category = 'sports',       type = 'automobile', shop = 'luxury' },
...
--  { model = 'neo',           name = 'Neo',                    brand = 'Vysser',     price = 230000,   category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'neon',          name = 'Neon',                   brand = 'Pfister',    price = 5730000,  category = 'sports',       type = 'automobile', shop = 'luxury' },
...
--  { model = 'cypher',        name = 'Cypher',                 brand = 'Übermacht',  price = 155000,   category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'sultan3',       name = 'Sultan Classic Custom',  brand = 'Karin',      price = 1750000,  category = 'sports',       type = 'automobile', shop = 'luxury' },
--  { model = 'rt3000',        name = 'RT3000',                 brand = 'Dinka',      price = 65000,    category = 'sports',       type = 'automobile', shop = 'luxury' },
    { model = 'sultanrs',      name = 'Sultan RS',              brand = 'Karin',      price = 2183250,  category = 'sports',       type = 'automobile', shop = 'luxury' },
...
--  { model = 'turismo3',      name = 'Turismo Omaggio',        brand = 'Grotti',     price = 284500,   category = 'super',        type = 'automobile', shop = 'luxury' },
    --- Motorcycles (8)
    { model = 'akuma',         name = 'Akuma',                  brand = 'Dinka',      price = 397500,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'avarus',        name = 'Avarus',                 brand = 'LCC',        price = 267500,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'bagger',        name = 'Bagger',                 brand = 'WMC',        price = 306500,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'bati',          name = 'Bati 801',               brand = 'Pegassi',    price = 376500,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
--  { model = 'bati2',         name = 'Bati 801RR',             brand = 'Pegassi',    price = 19000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'bf400',         name = 'BF400',                  brand = 'Nagasaki',   price = 1800000,  category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'carbonrs',      name = 'Carbon RS',              brand = 'Nagasaki',   price = 555000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
--  { model = 'chimera',       name = 'Chimera',                brand = 'Nagasaki',   price = 21000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'cliffhanger',   name = 'Cliffhanger',            brand = 'Western',    price = 110000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'daemon',        name = 'Daemon',                 brand = 'WMC',        price = 150000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'daemon2',       name = 'Daemon Custom',          brand = 'Western',    price = 160000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'defiler',       name = 'Defiler',                brand = 'Shitzu',     price = 389000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'diablous2',     name = 'Diablous Custom',        brand = 'Principe',   price = 38000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'double',        name = 'Double-T',               brand = 'Dinka',      price = 425000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
--  { model = 'enduro',        name = 'Enduro',                 brand = 'Dinka',      price = 5500,     category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'esskey',        name = 'Esskey',                 brand = 'Pegassi',    price = 315250,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'faggio',        name = 'Faggio Sport',           brand = 'Pegassi',    price = 110000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'faggio2',       name = 'Faggio',                 brand = 'Pegassi',    price = 170000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'faggio3',       name = 'Faggio Mod',             brand = 'Pegassi',    price = 1750000,  category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'fcr2',          name = 'FCR 1000 Custom',        brand = 'Pegassi',    price = 19000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'gargoyle',      name = 'Gargoyle',               brand = 'Western',    price = 170000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'lectro',        name = 'Lectro',                 brand = 'Principe',   price = 28000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'manchez',       name = 'Manchez',                brand = 'Maibatsu',   price = 110000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'ruffian',       name = 'Ruffian',                brand = 'Pegassi',    price = 25000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'sanchez',       name = 'Sanchez Livery',         brand = 'Maibatsu',   price = 170000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'sanchez2',      name = 'Sanchez',                brand = 'Maibatsu',   price = 110000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
--  { model = 'sanctus',       name = 'Sanctus',                brand = 'LCC',        price = 35000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'shotaro',       name = 'Shotaro',                brand = 'Nagasaki',   price = 848900,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'sovereign',     name = 'Sovereign',              brand = 'WMC',        price = 350000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'vortex',        name = 'Vortex',                 brand = 'Pegassi',    price = 31000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    { model = 'wolfsbane',     name = 'Wolfsbane',              brand = 'Western',    price = 280000,   category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
...
--  { model = 'pizzaboy',      name = 'Pizza Boy',              brand = 'Pegassi',    price = 50000,    category = 'motorcycles',  type = 'bike',       shop = 'pdm' },
    --- Off-Road (9)
    { model = 'bfinjection',   name = 'Bf Injection',           brand = 'Annis',      price = 827000,   category = 'offroad',      type = 'automobile', shop = 'pdm' },
    { model = 'bifta',         name = 'Bifta',                  brand = 'Annis',      price = 987900,   category = 'offroad',      type = 'automobile', shop = 'pdm' },
    { model = 'blazer',        name = 'Blazer',                 brand = 'Annis',      price = 470500,   category = 'offroad',      type = 'automobile', shop = 'pdm' },
...
--  { model = 'blazer5',       name = 'Blazer Aqua',            brand = 'Nagasaki',   price = 40000,    category = 'offroad',      type = 'automobile', shop = 'pdm' },
    { model = 'brawler',       name = 'Brawler',                brand = 'Annis',      price = 1060500,  category = 'offroad',      type = 'automobile', shop = 'pdm' },
...
--  { model = 'kamacho',       name = 'Kamacho',                brand = 'Canis',      price = 50000,    category = 'offroad',      type = 'automobile', shop = 'pdm' },
    { model = 'mesa3',         name = 'Mesa Merryweather',      brand = 'Canis',      price = 1602500,  category = 'offroad',      type = 'automobile', shop = 'pdm' },
...
--  { model = 'rancherxl',     name = 'Rancher XL',             brand = 'Declasse',   price = 24000,    category = 'offroad',      type = 'automobile', shop = 'pdm' },
    { model = 'rebel2',        name = 'Rebel',                  brand = 'Vapid',      price = 1060500,  category = 'offroad',      type = 'automobile', shop = 'pdm' },
...
--  { model = 'yosemite4',     name = 'Yosemite 1500',          brand = 'Declasse',   price = 187750,   category = 'offroad',      type = 'automobile', shop = 'pdm' },
    --- Industrial (10)
    { model = 'guardian',      name = 'Guardian',               brand = 'Vapid',      price = 1325000,  category = 'industrial',   type = 'automobile', shop = 'truck' },
...
--  { model = 'bobcatxl',      name = 'Bobcat XL Open',         brand = 'Vapid',      price = 13500,    category = 'vans',         type = 'automobile', shop = 'pdm' },
    { model = 'burrito3',      name = 'Burrito',                brand = 'Declasse',   price = 1270000,  category = 'vans',         type = 'automobile', shop = 'pdm' },
    { model = 'gburrito2',     name = 'Burrito Custom',         brand = 'Declasse',   price = 1860250,  category = 'vans',         type = 'automobile', shop = 'pdm' },
    { model = 'rumpo',         name = 'Rumpo',                  brand = 'Bravado',    price = 1503000,  category = 'vans',         type = 'automobile', shop = 'pdm' },
--  { model = 'journey',       name = 'Journey',                brand = 'Zirconium',  price = 6500,     category = 'vans',         type = 'automobile', shop = 'pdm' },
    { model = 'minivan',       name = 'Minivan',                brand = 'Vapid',      price = 1042000,  category = 'vans',         type = 'automobile', shop = 'pdm' },
...
--  { model = 'formula',       name = 'PR4',                    brand = 'Progen',     price = 100000,   category = 'openwheel',    type = 'automobile', shop = 'none' },
    ...
    { model = 'gbbisonhf',     name = 'gbbisonhf',     brand = 'TIKUM', price = 9753123, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbbriosof',     name = 'gbbriosof',     brand = 'TIKUM', price = 4198756, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbcometcl',     name = 'gbcometcl',     brand = 'TIKUM', price = 6823441, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbcomets1t',    name = 'gbcomets1t',    brand = 'TIKUM', price = 7345098, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbcomets2rc',   name = 'gbcomets2rc',   brand = 'TIKUM', price = 5512345, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbdominatorgsx',name = 'gbdominatorgsx',brand = 'TIKUM', price = 9012876, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbgresleystx',  name = 'gbgresleystx',  brand = 'TIKUM', price = 4876543, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbhades',       name = 'gbhades',       brand = 'TIKUM', price = 6321987, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbharmann',     name = 'gbharmann',     brand = 'TIKUM', price = 8543210, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbimpaler',     name = 'gbimpaler',     brand = 'TIKUM', price = 7987654, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbirisz',       name = 'gbirisz',       brand = 'TIKUM', price = 5123456, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbissimetro',   name = 'gbissimetro',   brand = 'TIKUM', price = 6789012, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gblod4',        name = 'gblod4',        brand = 'TIKUM', price = 9234567, category = 'sports', type = 'automobile', shop = 'pdm' },
    { model = 'gbmojave',      name = 'gbmojave',      brand = 'TIKUM', price = 4567890, category = 'sports', type = 'automobile', shop = 'pdm' },
    -- PDM
    { model = '19gv80',      name = '19gv80',      brand = 'TIKUM', price = 1602500,  category = 'suvs',          type = 'automobile', shop = 'pdm' },
    { model = '77Monte',     name = '77Monte',     brand = 'TIKUM', price = 14850000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = '16charger',   name = '16charger',   brand = 'TIKUM', price = 14850000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'BOSS429',     name = 'BOSS429',     brand = 'TIKUM', price = 19800000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'chargerf8',   name = 'chargerf8',   brand = 'TIKUM', price = 16250000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodcharger', name = 'rmodcharger', brand = 'TIKUM', price = 17100000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodcharger69',name = 'rmodcharger69',brand = 'TIKUM', price = 18900000, category = 'muscle',      type = 'automobile', shop = 'pdm' },
    { model = 'raid',        name = 'raid',        brand = 'TIKUM', price = 15300000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'HELLCATF9',   name = 'HELLCATF9',   brand = 'TIKUM', price = 19550000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'hellcatlb',   name = 'hellcatlb',   brand = 'TIKUM', price = 20000000, category = 'muscle',        type = 'automobile', shop = 'pdm' },
    { model = 'fd370z',      name = 'fd370z',      brand = 'TIKUM', price = 16750000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = 'm3e36',       name = 'm3e36',       brand = 'TIKUM', price = 15900000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = 'm3e92',       name = 'm3e92',       brand = 'TIKUM', price = 16400000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = 'civic2020',   name = 'civic2020',   brand = 'TIKUM', price = 13800000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = 'animfk8hr',   name = 'animfk8hr',   brand = 'TIKUM', price = 14500000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = 'evo9drift',   name = 'evo9drift',   brand = 'TIKUM', price = 17200000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = '74civrswb',   name = '74civrswb',   brand = 'TIKUM', price = 11137500, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = '350z',        name = '350z',        brand = 'TIKUM', price = 11137500, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = '2nddragg',    name = '2nddragg',    brand = 'TIKUM', price = 10420000, category = 'sports',        type = 'automobile', shop = 'pdm' },
    { model = '356a',        name = '356a',        brand = 'TIKUM', price = 18300000, category = 'sportsclassic', type = 'automobile', shop = 'pdm' },
    { model = '2018s650p',   name = '2018s650p',   brand = 'TIKUM', price = 19200000, category = 'sedans',        type = 'automobile', shop = 'pdm' },
    { model = 'AAQ4',        name = 'AAQ4',        brand = 'TIKUM', price = 14100000, category = 'sedans',        type = 'automobile', shop = 'pdm' },
    { model = 'alpinab7',    name = 'alpinab7',    brand = 'TIKUM', price = 17800000, category = 'sedans',        type = 'automobile', shop = 'pdm' },
    { model = '1500ghoul',   name = '1500ghoul',   brand = 'TIKUM', price = 16800000, category = 'offroad',       type = 'automobile', shop = 'pdm' },
    { model = 'ramtrx6x6',   name = 'ramtrx6x6',   brand = 'TIKUM', price = 19450000, category = 'offroad',       type = 'automobile', shop = 'pdm' },
    { model = '6x6',         name = '6x6',         brand = 'TIKUM', price = 10420000, category = 'offroad',       type = 'automobile', shop = 'pdm' },
    { model = '17silvk9rb',  name = '17silvk9rb',  brand = 'TIKUM', price = 10420000, category = 'offroad',       type = 'automobile', shop = 'pdm' },
    { model = 'aerox155',    name = 'aerox155',    brand = 'TIKUM', price = 90987390, category = 'motorcycles',   type = 'bike',       shop = 'pdm' },
    { model = 'fangle450',   name = 'fangle450',   brand = 'TIKUM', price = 90987390, category = 'motorcycles',   type = 'bike',       shop = 'pdm' },

    --DONASI
    { model = 'gbbanshees',    name = 'gbbanshees',    brand = 'TIKUM', price = 8765432, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbclubxr',      name = 'gbclubxr',      brand = 'TIKUM', price = 6543210, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbcomets2r',    name = 'gbcomets2r',    brand = 'TIKUM', price = 9876543, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbemerussb1',   name = 'gbemerussb1',   brand = 'TIKUM', price = 7654321, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbkomodagt',    name = 'gbkomodagt',    brand = 'TIKUM', price = 5432109, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbmilano',      name = 'gbmilano',      brand = 'TIKUM', price = 8901234, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbneonct',      name = 'gbneonct',      brand = 'TIKUM', price = 6789012, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbnexusrr',     name = 'gbnexusrr',     brand = 'TIKUM', price = 9123456, category = 'sports', type = 'automobile', shop = 'donasi' },
    { model = 'gbeon',         name = 'gbeon',         brand = 'TIKUM', price = 1000000, category = 'sports', type = 'automobile', shop = 'donasi' }, --BENEFIT CEWE
    { model = 'f82duke',       name = 'f82duke',       brand = 'TIKUM', price = 6789012, category = 'sports', type = 'automobile', shop = 'donasi' }, --MOBIL BON2
}
