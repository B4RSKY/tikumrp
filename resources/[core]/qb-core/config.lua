...
QBConfig.DefaultSpawn = vector4(-1037.6, -2737.66, 20.17, 331.83)
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 150000, bank = 100000} -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
