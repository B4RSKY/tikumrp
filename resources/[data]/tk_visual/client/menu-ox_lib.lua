if Config.Menu == "ox_lib" then
    if lib then
        Config.mainMenu = "tk_visual_main_menu"
        Config.fpsMenu = "tk_visual_fps_menu"
        Config.visualMenu = "tk_visual_visual_menu"
        Config.lightsMenu = "tk_visual_light_menu"
        Config.dayLightsMenu = "tk_visual_day_light_menu"
        Config.nightLightsMenu = "tk_visual_night_light_menu"
        ...
        local function generateLightButton(light, settingName, time)
            return {
                ...
                args = { onClick = function(selected)
                    ...
                    lib.hideMenu()
                    local input = lib.inputDialog("tk_visual", {
        ...
        error("Error: ox_lib resource is not properly loaded inside tk_visual!")
    end
end