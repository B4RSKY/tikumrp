...
export const ClientInfo = () => {
  ...
  const { real_time, server_info, bank, active, cash, job, player_source, time, positions } = ClientInfo;
        ...
        <div id="client_info" className="absolute select-none 4k:scale-150 4k:-translate-x-16 4k:translate-y-20" style={posStyle}>
          ...
          >
            ...
            <div className="flex flex-col justify-end select-none">
                ...
                <div className="flex flex-col items-end justify-start">
                  ...
                  {real_time.active && time.show && (
                    <div className="flex justify-end w-full">
                      <h1 className="text-xs font-bold text-white text-right">{getFormattedDate()}</h1>
                    </div>
                  )}
                </div>
              ...
              {server_info.active && server_info.show && <h1 className={classNames("text-xs text-white text-right font-medium", { "-mt-3": time.active && time.show })}><br></br></h1>}
