      ...
      <>
        <div id="compass" className="absolute top-0 left-1/2 -translate-x-1/2 select-none 4k:scale-150 4k:translate-y-4">
          <div className="flex flex-col w-full max-w-screen-sm mx-auto items-center compass">
            <div
              className="flex relative justify-center items-end gap-2 bg-purple pt-1 pb-1 2k:pb-2 w-full"
              style={{
            ...
            >
              <div className="street1 w-32 2k:w-40 overflow-hidden">
                <h1 className="text-nowrap text-purple/90 whitespace-nowrap">{Compass?.street1}</h1>
              </div>
              <div className="direction relative flex justify-center px-6">
                <div className="triangle-bottom absolute z-50"></div>
                <div className="relative font-medium text-purple w-[180px]">
                  <svg className="directions transition-transform h-8 w-full flex pt-5">
                    <text x="0" y="4.5" fill="purple" textAnchor="middle">
                      N
                    </text>
                    <text x="360" y="4.5" fill="purple" textAnchor="middle">
                      N
                    </text>
                    <text className="side" x="315" y="4.5" fill="purple" textAnchor="middle">
                      NW
                    </text>
                    <text className="side" x="-45" y="4.5" fill="purple" textAnchor="middle">
                      NW
                    </text>
                    ...
                    <text className="side" x="405" y="4.5" fill="purple" textAnchor="middle">
                      NE
                    </text>

                    <text x="90" y="4.5" fill="purple" textAnchor="middle">
                      E
                    </text>
                    <text className="side" x="135" y="4.5" fill="purple" textAnchor="middle">
                      SE
                    </text>
                    <text x="180" y="4.5" fill="purple" textAnchor="middle">
                      S
                    </text>
                    <text className="side" x="225" y="4.5" fill="purple" textAnchor="middle">
                      SW
                    </text>
                    <text x="270" y="4.5" fill="purple" textAnchor="middle">
                      W
                    </text>
                  </svg>
                </div>
              ...
              <div className="street2 w-32 2k:w-40 overflow-hidden">
                <h1 className="text-nowrap text-purple/90 whitespace-nowrap">{Compass?.street2}</h1>
              </div>
            </div>
          </div>
        </div>
