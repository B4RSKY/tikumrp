...
RegisterNetEvent('tk_admin/client/fling-player', function()
    FlingPlayer()
end)

RegisterNetEvent("tk_admin/client/drunk", function()
    drunkThread()
end)

RegisterNetEvent("tk_admin/client/animal-attack", function()
    startWildAttack()
end)

RegisterNetEvent("tk_admin/client/set-fire", function()
