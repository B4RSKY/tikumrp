...
if (IsDuplicityVersion()) then
    SetTimeout(1000, function()
        MySQL.query([[
            CREATE TABLE IF NOT EXISTS `bansapanel` (
    ...
    Compat = {
        ...
        GetPlayerList = function()
            ...
            for k, Player in pairs(QBCore.Functions.GetQBPlayers()) do
                if Player then
                    local identifiers, steamIdentifier = GetPlayerIdentifiers(Player.PlayerData.source)
                    ...
                    table.insert(PlayerList,
                        {
                            ...
                            role = LoadedRole[Player.PlayerData.source],
