...
Config.ServerName                           = "TITIK KUMPUL ROLEPLAY"
Config.ServerDiscord                        = "https://discord.gg/a9SPzgegrp" -- For kick/ban messages
Config.ScreenshotWebhook                    = ""
Config.LogsWebhook                          = ""

Config.NoClipKey                            = ""
Config.AdminPanelKey                        = ""
Config.ShowNamesKey                         = ""
...
Config.ReportCommand                        = "reporttt"              -- The command to use for reports (default /report)
...
Config.DB.BansTable                         = "bansapanel"
...
Config.AllPlayersUseNames                   = true                 -- Wheter or not all players can use the overhead names
...
Config.Permissions = {
    ["god"] = {
        AllowedActions = {
            "adminmenu", -- Access the Resource control page
    ...
    ["admin"] = {
        AllowedActions = {
            "adminmenu", -- Access the All Characters page
            "characterspage", -- Access the All Characters page
            "deletecharacter", -- Delete a character
            "messageall", -- Message all players
            "leaderboardinfo", --Check the leaderboards
