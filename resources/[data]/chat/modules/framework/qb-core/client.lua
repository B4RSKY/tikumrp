...
RegisterNetEvent('QBCore:Client:OnJobUpdate', function(data)
    TriggerEvent('chat:client:onPlayerJobUpdate', data.name, data.label, data.grade_label, data.grade)
end)
...
RegisterNetEvent('QBCore:Client:OnGangUpdate', function(data)
    ...
    TriggerEvent('chat:client:onPlayerGangUpdate', PlayerGangName, PlayerGangLabel, PlayerGangGradeName, PlayerGangGradeLevel)
    --]]
end)
