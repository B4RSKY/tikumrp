...
---This will return a boolean if the player has the permission.
---@param src number
---@param permission string|table
---@return boolean
Framework.HasPermission = function(src, permission)
    return QBox:HasGroup(src, permission)
end
...
Framework.AddItem = function(src, item, amount, slot, metadata)
    local player = Framework.GetPlayer(src)
    if not player then return end
    TriggerClientEvent("chat:client:inventory:updateInventory", src,
...
RegisterNetEvent("QBCore:Server:OnPlayerLoaded", function()
    local src = source
    TriggerEvent("chat:server:onPlayerLoaded", src)
end)

RegisterNetEvent("QBCore:Server:OnPlayerUnload", function()
    local src = source
    TriggerEvent("chat:server:onPlayerUnload", src)
end)
