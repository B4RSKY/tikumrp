...
Config.Drawbles[`mp_m_freemode_01`] = {
	["Top"] = {
		Drawable = 11,
	...
	["Shoes"] = {
		Drawable = 6,
		Table = {Standalone = true, Cloth = 34},
		Emote = {Dict = "random@domestic", Anim = "pickup_low", Move = 0, Dur = 1200}
	},
	["Neck"] = {
		Drawable = 7,
		Table = {Standalone = true, Cloth = 0 },
...
Config.Drawbles[`mp_f_freemode_01`] = {
	["Top"] = {
		Drawable = 11,
		Table = Variations.Jackets,
		Emote = {Dict = "missmic4", Anim = "michael_tux_fidget", Move = 51, Dur = 1500}
	...
	["Shoes"] = {
		Drawable = 6,
		Table = {Standalone = true, Cloth = 97},
		Emote = {Dict = "random@domestic", Anim = "pickup_low", Move = 0, Dur = 1200}
	},
	["Neck"] = {
		Drawable = 7,
	...
	["Vest"] = {
		Drawable = 9,
		Table = {Standalone = true, Cloth = 164 },
		Emote = {Dict = "clothingtie", Anim = "try_tie_negative_a", Move = 51, Dur = 1200}
	},
	["Bag"] = {
		Drawable = 5,
...
local Drawables = Config.Drawbles

Config.Extras[`mp_m_freemode_01`] = {
	["Shirt"] = {
		Drawable = 11,
		Table = {
			Standalone = true, Cloth = 15,
			Extra = { 
	...
	["Pants"] = {
		Drawable = 4,
		Table = {Standalone = true, Cloth = 21},
...
Config.Extras[`mp_f_freemode_01`] = {
	["Shirt"] = {
		Drawable = 11,
		Table = {
			Standalone = true, Cloth = 186,
			Extra = { 
						{Drawable = 8, Id = 15, Tex = 0, Name = "Extra Undershirt"},
						{Drawable = 3, Id = 15, Tex = 0, Name = "Extra Gloves"},
						{Drawable = 10, Id = 0, Tex = 0, Name = "Extra Decals"},
	...
	["Pants"] = {
		Drawable = 4,
		Table = {Standalone = true, Cloth = 268},
		Emote = {Dict = "re@construction", Anim = "out_of_breath", Move = 51, Dur = 1300}
	},
	["Bagoff"] = {
		Drawable = 5,
...
function ResetClothing(anim)
	local Ped = PlayerPedId()
	local _, Models = IsMpPed(Ped)
	local e = Drawables[Models].Top.Emote
...
function ToggleClothing(which, extra)
    ...
    local Ped = PlayerPedId()
    local Gender, Models = IsMpPed(Ped)
    local Toggle = Drawables[Models][which]
    
    if extra then 
        Toggle = Extras[Models][which]
    end
    ...
    -- print(json.encode(Toggle, {indent = true}))
    local Table = Toggle.Table.Cloth
...
function ToggleProps(which)
	...
	if not Prop.Variants then
		...
		local Gender, Model = IsMpPed(Ped)
		...
		local Variations = Prop.Variants[Model]
