return {
	...
	['identification'] = {
		...
		consume = 0,
		client = {
			export = 'tk_identification.identification'
		}
	},
	['driver_license'] = {
	...
	["benih_micin"] = {
		...
		stack = true,
		close = true,
		description = "Bahan Mentah untuk dijadikan drugs(Illegal)",
		client = {event = 'tk-illegal:nanem:useItem'}
	},
	["bubuk_ketawa"] = {
		label = "Bubuk Ketawa",
		weight = 100,
		stack = true,
		close = true,
		description = "Bahan Olahan drugs(Illegal)",
	},
	["micin"] = {
		label = "Micin",
		weight = 100,
		stack = true,
		close = true,
		description = "Olahan drugs(Illegal)",
	},
	["micin_turbo"] = {
		label = "Micin",
		weight = 100,
