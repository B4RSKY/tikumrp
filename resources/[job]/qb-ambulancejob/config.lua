...
Config.BleedTickRate = 90                                    -- How much time, in seconds, between bleed ticks
Config.BleedMovementTick = 45                                -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
Config.BleedMovementAdvance = 25                              -- How much time moving while bleeding adds
...
Config.AdvanceBleedTimer = 90                                -- How many bleed ticks occur before bleed level increases
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        vector3(361.74, -1411.14, 32.43)
    },
    ['duty'] = {
        vector3(359.94, -1412.36, 32.43)
    },
    ['roof'] = {
    ...
    ['beds'] = {
        { coords = vector4(343.44, -1420.81, 38.19, 55.65), taken = false, model = -1069199941 },
        { coords = vector4(341.35, -1423.2, 38.19, 52.58),  taken = false, model = -1069199941 },
        { coords = vector4(339.11, -1425.68, 38.19, 48.03),   taken = false, model = -1069199941 },
        { coords = vector4(336.92, -1428.39, 38.19, 53.96),   taken = false, model = -1069199941 },
    },
    ['jailbeds'] = {
    ...
    ['hospital'] = {
        {
            ...
            ['location'] = vector3(337.95, -1394.27, 32.51),
            ['beds'] = {
                { coords = vector4(343.44, -1420.81, 38.19, 55.65), taken = false, model = -1069199941 },
                { coords = vector4(341.35, -1423.2, 38.19, 52.58),  taken = false, model = -1069199941 },
                { coords = vector4(339.11, -1425.68, 38.19, 48.03),   taken = false, model = -1069199941 },
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(337.95, -1394.27, 32.51) }
    }
}
...
Config.Price = 1200
Config.ReviveTime = 5000  --in msec