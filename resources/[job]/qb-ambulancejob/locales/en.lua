local Translations = {
    ...
    info = {
        ...
        wep_unknown = 'Unknown',
        respawn_txt = 'RESPAWN DALAM: ~r~%{deathtime}~s~ DETIK',
        respawn_revive = 'TAHAN [~r~E~s~] SELAMA %{holdtime} DETIK UNTUK RESPAWN, $~r~%{cost}~s~',
        bleed_out = 'ANDA AKAN KEHABISAN DARAH DALAM: ~r~%{time}~s~ DETIK',
        bleed_out_help = 'ANDA AKAN KEHABISAN DARAH DALAM: ~r~%{time}~s~ DETIK, ANDA BISA DIBANTU',
        request_help = 'TEKAN [~r~G~s~] UNTUK MEMINTA BANTUAN EMS',
        help_requested = 'PERSONEL EMS TELAH DIBERITAHU',
