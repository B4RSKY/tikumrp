...
Config.ox_lib = true -- use ox_lib, if true don't forget to load ox_lib in resource manifest
Config.tickupdate = 5 -- time to update the blips from server in seconds (performance matters)
Config.sirenupdate = 5 -- time to update siren state (client) in seconds (performance matters)
...
Config.authorizedJob = {
    ...
    ambulance = {
        ...
        sharedjobs = {
            ambulance = true,
            police = 50.0, -- this means police job can also see ambulance blips
        }
    },
    mechanic = {
        color = 25,
