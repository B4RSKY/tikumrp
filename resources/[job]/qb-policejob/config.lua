...
Config.Locations = {
    duty = {
        vector3(86.21, -402.85, 41.62),
        vector3(-449.811, 6012.909, 31.815),
    },
    vehicle = {
        vector4(53.4, -391.26, 39.13, 249.81),
        vector4(471.13, -1024.05, 28.17, 274.5),
        vector4(-455.39, 6002.02, 31.34, 87.93),
    },
    vehiclse = {
        vector3(47.27, -386.37, 39.13),
    },
    impound = {
        vector3(57.95, -378.74, 39.13),
        vector3(-436.14, 5982.63, 31.34),
    },
    helicopter = {
        vector4(86.76, -404.58, 55.33, 336.27),
        vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    fingerprint = {
        vector3(89.31, -421.84, 47.31),
    },
    stations = {
        { label = 'Kantor Polisi',        coords = vector4(95.38, -369.65, 42.33, 20.32) },
