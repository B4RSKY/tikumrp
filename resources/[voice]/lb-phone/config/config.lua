...
Config.PhoneNumber = {}
Config.PhoneNumber.Format = "({4}) {3}-{3}" -- Don't touch unless you know what you're doing. IMPORTANT: The sum of the numbers needs to be equal to the phone number length + prefix length
...
Config.CurrencyFormat = "TK$%s" -- ($100) Choose the formatting of the currency. %s will be replaced with the amount.
...
Config.TransferLimits.Daily = true -- The maximum amount of money that can be transferred in a day. Set to false for unlimited.
Config.TransferLimits.Weekly = true -- The maximum amount of money that can be transferred in a week. Set to false for unlimited.
...
Config.CityName = "TITIK KUMPUL" -- The name that's being used in the weather app etc.
...
Config.EmailDomain = "titikkumpulrp.id"
